...
class Nodo:
    ...
    def __eq__(self, __value) -> bool:
        return isinstance(__value, Nodo) and self.estado == __value.estado
...
# nodo_inicial = Nodo(estado_inicial, None, 0, calcular_h(estado_inicial))
# for n in nodo_inicial.get_sucesores():
#     print(n)
